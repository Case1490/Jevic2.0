...
const SuscribeNews = () => {
  return (
    <div className="mt-[70px]">
      <div
        className="flex flex-1 flex-col items-center justify-center text-center p-6 shadow-lg text-white bg-cover bg-center relative h-[400px]"
        style={{
        ...
        <div className="relative w-[80%] m-auto">
          ...
          <div className="input-group">
            <input
              ...
              autoComplete="off"
            />
            <input className="button--submit" value="Suscríbete" type="submit" />
          </div>
        </div>
      </div>
    </div>
